//we're doing this in js bc a reducer is just a function, there is nothing to render
...
function reducer(state, { type, payload: { name, step } }) {
    switch (type) {
        case "add_adventurer": {
            if (name === '') {
                //what i return is how the state is updated
                //since im returning state, we have updated nothing
